...
export default function Entrypoint() {
    ...
    return (
        <div id="full-page" className="h-screen flex items-center justify-center bg-cover bg-center text-white" style={{ backgroundImage: "url(/trevo/assets/background.png)" }}>
            <div id="entry-container" className={`relative flex flex-col items-center justify-center text-center ${matches ? "bg-[#121212] w-120 h-133 rounded-3xl shadow-lg" : "w-full h-full bg-transparent"}`}>
                ...
                <img src="/trevo/assets/logoentrypoint.png" alt="logo illustration" className={`${matches ? "h-15 w-15 mt-[20px]" : "h-20 w-20 mt-20"} mx-auto`} />
